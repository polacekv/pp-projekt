...
const CONFIG = {
  ...
  APP_SCRIPT_URL: localStorage.getItem('pp_api_url') || 'https://script.google.com/macros/s/AKfycbxGjhTq8a8rZcEEH4zclI_z9GMIEMlnLwPjsrw7NEIKoU43i5TbojKa805UJE6TgT9xOQ/exec',
...
const API = {
  ...
  async call(action, sheet, payload) {
    ...
    try {
      // Vše přes GET (obchází CORS preflight blokované Apps Script)
